...
export const validateCreateUser = [
    ...
    body('password')
        .isLength({ min: 8 })
        .withMessage('Le mot de passe doit contenir au 8 caractères.'),
]
...
export const validateUpdateUser = [
    ...
    body('password')
        .optional()
        .isLength({ min: 12 })
        .withMessage('Le mot de passe doit contenir au 12 caractères.'),
]
...
export const validateActivationUser = [
    body('isActive')
        .isBoolean()
        .withMessage(
            "Le champ 'isActive' doit être un booléen (true ou false)."
        ),
]
...
export const validateCreatePermission = [
    ...
    body('description')
        .notEmpty()
        .withMessage('La description de la permission est requis.'),
]
...
export const validateCreateFAQ = [
    body('question')
        ...
        .isLength({ min: 10 })
        .withMessage('La question doit contenir au moins 10 caractères.'),
    body('answer')
        .notEmpty()
        .withMessage('La réponse est requise.')
        .isLength({ min: 10 })
        .withMessage('La réponse doit contenir au moins 10 caractères.'),
]
